...
void app_main(void) {
    ...
    remove_dir(MOUNT_POINT "/mydir");
    list_dir(MOUNT_POINT, 2);

    write_file(MOUNT_POINT "/hello.txt", "Hello ");
    append_file(MOUNT_POINT "/hello.txt", "World!\n");
    read_file(MOUNT_POINT "/hello.txt");

    delete_file(MOUNT_POINT "/foo.txt");
    rename_file(MOUNT_POINT "/hello.txt", MOUNT_POINT "/foo.txt");
    read_file(MOUNT_POINT "/foo.txt");

    test_file_io(MOUNT_POINT "/test.txt");
